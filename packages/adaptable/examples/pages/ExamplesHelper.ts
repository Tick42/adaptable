...
export class ExamplesHelper {
  ...
  public getGridOptionsTreeData(): GridOptions {
    var columnDefs = [
      // we're using the auto group column by default!
      { field: 'cabinetId', filter: true, sortable: true, cellClass: 'number-cell' },
      { field: 'title', filter: true, sortable: true, enableRowGroup: true },
      { field: 'area', filter: true, sortable: true },
      { field: 'salary', editable: true, sortable: true, cellClass: 'number-cell' },
      {
        field: 'staff',
        editable: true,
        sortable: true,
    ...
    return {
      ...
      sideBar: true,
      rowSelection: 'multiple',
      //   getRowNodeId: item => item.employeeId,
      columnTypes: {
        abColDefNumber: {},
        abColDefString: {},
        abColDefBoolean: {},
